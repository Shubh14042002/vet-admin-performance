...
export default function () {
   // Fetch Patients
   let res = http.get("http://localhost:3000/patients");
   ...
   let postRes = http.post("http://localhost:3000/patients", payload, params);
   ...
   let deleteRes = http.del(`http://localhost:3000/patients/${patientId}`);
